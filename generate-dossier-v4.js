...
bodyChildren.push(
  ...
  para('Parad\u00f3jicamente, BirdeyeClient.getOHLCV() ya est\u00e1 implementado y funcional, soportando timeframes desde 1 minuto hasta 1 d\u00eda. Sin embargo, nunca se ha establecido un pipeline que persista estos datos ni los alimente al motor predictivo. La funci\u00f3n se invoca \u00fanicamente desde la ruta de detalle de token como una operaci\u00f3n fire-and-forget que no se almacena de forma persistente. Adem\u00e1s, no existe un modelo PriceCandle en el schema de Prisma, por lo que no hay tabla donde guardar datos OHLCV hist\u00f3ricos.'),
...
bodyChildren.push(
  ...
  bulletItem('Birdeye: OHLCV (velas japonesas desde 1m hasta 1D), historial de wallets, listas de tokens, new listings. Fuente principal de datos hist\u00f3ricos de precios.'),
...
bodyChildren.push(
  ...
  ...codeBlock([
    ...
    '  source      String   // "birdeye" | "dexscreener" | "internal"',
